...
urlpatterns = [
    ...
    path('categories/',views.categories,name="manager-categories"),
    ...
    path('invoices/',views.invoices,name="manager-invoices"),
    ...
    path('suppliers/',views.supplier,name="manager-suppliers"),
